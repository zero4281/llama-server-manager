...
def parse_asset_name(name: str) -> Dict[str, str]:
    ...
    # V2 Pattern: platform is greedy, backend is optional
...
# Test 3: rocky-linux-x64
print(f"rocky-linux-x64: {parse_asset_name('llama-b8800-bin-rocky-linux-x64.tar.gz')}")
# Test 4: rocky-linux-vulkan-x64
print(f"rocky-linux-vulkan-x64: {parse_asset_name('llama-b8800-bin-rocky-linux-vulkan-x64.tar.gz')}")
